            ...
            <Swiper navigation={true} modules={[Navigation, Autoplay ]} autoplay={{delay: 3000}} className="mySwiper">
                <SwiperSlide>
                    <div className="image">
                        ...
                        <div className="text">
                            <h3 className="text-h3">Presenting Perfect Cosmetics</h3>
                            <h1 className="text-h1">Beauty that is you</h1>
                ...
                <SwiperSlide>
                    <div className="image">
                        ...
                        <div className="text1">
                            <h3 className="text-h3">Iva Beauty Products</h3>
                            <h1 className="text-h1">Power Clay SPF20</h1>
                            <p className="title">Long lastic formula</p>
                            <p className="description">(long hours Guarantee)</p>
                            <p className="title">Long lastic formula</p>
                            <p className="description">(long hours Guarantee)</p>
                            <img className="res-image" width="80%" src="https://dtiva.wpengine.com/wp-content/uploads/2020/06/cream.png" alt="" />
                            <button>Shop Now</button>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="image">
                        ...
                        <div className="text2">
                            <h3 className="text-h3">Complate cosmetic solution</h3>
                            <h1 className="text-h1">Face Moisturers <br /> to Blushes</h1>
